...
const AboutTwo = () => {
  return (
    <section className="flex flex-col md:flex-row items-start justify-between p-8 gap-8 relative bg-white text-black">
  ...
  Designers
      ...
      <div className="md:w-1/3 w-full mt-8 md:mt-0">
        <ul className="space-y-4">
          <li>
            <a href="#" className="text-lg underline text-black hover:text-gray-600">
        ...
        <p className="text-gray-700 text-sm mt-4">
          Specialize in preserving and restoring historical buildings, employing expertise in architectural conservation,
